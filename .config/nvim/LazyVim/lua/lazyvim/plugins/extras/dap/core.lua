...
return {
  {
    ...
    -- stylua: ignore
    keys = {
      { "<leader>,d", function() require("dap").set_breakpoint(vim.fn.input('Breakpoint condition: ')) end, desc = "Breakpoint Condition" },
      { "<leader>,b", function() require("dap").toggle_breakpoint() end, desc = "Toggle Breakpoint" },
      { "<leader>,c", function() require("dap").continue() end, desc = "Run/Continue" },
      { "<leader>,a", function() require("dap").continue({ before = get_args }) end, desc = "Run with Args" },
      { "<leader>,f", function() require("dap").run_to_cursor() end, desc = "Run to Cursor" },
      ...
      { "<leader>,h", function() require("dap").step_over() end, desc = "Step Over" },
      { "<leader>,m", function() require("dap").pause() end, desc = "Pause" },
